...
GEMINI_MODEL_FULLNAME="gemini/gemini-2.0-flash"
OPENAI_MODEL_FULLNAME="gpt-4o-mini"
DEEPSEEK_MODEL_FULLNAME ="deepseek/deepseek-reasoner"
ollama_MODEL_FULLNAME = "ollama/llama3:70b"

MODELS_USED = {
    OPENAI_MODEL_FULLNAME: {"OPENAI_API_KEY"},
    GEMINI_MODEL_FULLNAME: {"GEMINI_API_KEY"},
    DEEPSEEK_MODEL_FULLNAME : {"DEEPSEEK_API_KEY"},
    ollama_MODEL_FULLNAME : {"Ollama_API_KEY"}
}
